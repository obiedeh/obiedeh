...
AI Systems Engineer focused on Physical AI, Edge Inference, Runtime Observability, and AI Infrastructure. The portfolio is organized around systems that connect models to constrained hardware, telemetry, robotics workflows, network intelligence, and human-reviewed operations.
...
1. `physical-ai-jetson-robotics`
   ...
   - **Evidence still needed:** Hardware run logs, benchmark artifacts, and completed sim-to-real validation.
