...
| **Physical AI Safety Observability** · [repository](https://github.com/obiedeh/physical-ai-safety-observability) | Runtime safety layer: structured safety events, policy engine for PPE, zones and proximity, operator review API, telemetry hooks | None yet. Mock VLM adapter, synthetic and file frame sources, artifact directories hold placeholders. | Scaffold. Public repository, MIT. |
